...
public class Teknoloji  extends Fragment {
    private ListView lv;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View vi = inflater.inflate(R.layout.fragment_tekno, container, false);
        lv = (ListView) vi.findViewById(R.id.listtekno);
    ...
    public void getData() {
        ...
        Query query = mRefTekno.orderByChild("postKategori").equalTo("Teknoloji");
